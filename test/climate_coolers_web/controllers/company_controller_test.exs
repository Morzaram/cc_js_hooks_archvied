defmodule ClimateCoolersWeb.CompanyControllerTest do
  use ClimateCoolersWeb.ConnCase

  import ClimateCoolers.CompaniesFixtures

  @create_attrs %{description: "some description", established_at: ~D[2022-02-05], name: "some name", pro_climate: true, url: "some url"}
